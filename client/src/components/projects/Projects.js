  ...
  return (
    <div className="containerBody">
      ...
      <div className="containerProject">
        ...
        <a href="https://github.com/krystleM26/hi-app" className="card_btn">
          {' '}
      ...
      <div className="containerProject">
        <div className="img-card">
          <img
            src="https://images.unsplash.com/photo-1518310952931-b1de897abd40?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=80&raw_url=true&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1742"
            alt=""
          />
        </div>
        <h3 className="card-title">Gym Ratz</h3>
        <p className="card_info">
          Get off your couch, and join Gym Ratz anywhere in the world
        </p>
        <a href="https://gym-ratz.herokuapp.com/" className="card__btn">
          {' '}
          <button>View Project </button>
        </a>
      </div>
