...
const About = () => {
 ...
 <div  className='aboutMe'>
    ...
    I have an interest in professional projects that involve working with AI. I would love to contribute to and improve business-integrated AI systems. I have learned that it is a smoother transition to work with AI as a software engineer due to the continuous study of algorithms and data structures, and deployment.
